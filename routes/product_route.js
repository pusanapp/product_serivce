...
router.get('/all/test', productController.getAllProductNew)
router.post('/available', productController.getAvailableProduct)
...
router.get('/all/type/:type', productController.getProductsByType)
